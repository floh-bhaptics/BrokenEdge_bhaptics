...
namespace MyBhapticsTactsuit
{
    public class TactsuitVR
    {
        ...
        public void SwordRecoil(bool isRightHand, bool twoHanded, float intensity = 1.0f)
        {
            float duration = 1.0f;
            ...
            string keyArm = "SwordArm" + postfix;
            ...
            if (twoHanded)
            {
                string otherKeyArm = "SwordArm" + otherPostfix;
                string otherKeyHands = "SwordHand" + otherPostfix;
                var otherScaleOption = new bHapticsLib.ScaleOption(intensity * 0.8f, duration);
                bHapticsLib.bHapticsManager.PlayRegistered(otherKeyHands, otherKeyHands, otherScaleOption, rotationFront);
                bHapticsLib.bHapticsManager.PlayRegistered(otherKeyArm, otherKeyArm, otherScaleOption, rotationFront);
            }
        }
